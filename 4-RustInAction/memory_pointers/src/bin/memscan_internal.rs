static GLOBAL: i32 = 1000;             // global static = global VAR

fn noop() -> *const i32 {
    let noop_local = 12345;            // global static
    &noop_local as *const i32          // local var within noop()
}

fn main() {
    let local_str = "a";               // local variables...
    let local_int = 123;               // ...
